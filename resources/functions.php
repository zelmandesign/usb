...
//Yoast to the bottom of the page
...
// Redirect Archive to a page
function archive_to_custom_archive() {
    if( is_post_type_archive( 'usb-product' ) ) {
        wp_redirect( home_url( '/usb-sticks/' ), 301 );
        exit();
    }

    if( is_post_type_archive( 'mobile-product' ) ) {
        wp_redirect( home_url( '/mobile-accessories/' ), 301 );
        exit();
    }
}
